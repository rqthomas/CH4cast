...
### Figure S2 ### SWI temperature forecasts
############################################################################################
...
### Figure S3 ### Temperature catwalk and HOBO loggers comparison via linear model
############################################################################################
...
parms <- read_csv("parameter_estimates_22Jun20.csv")
